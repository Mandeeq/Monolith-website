...
$config = [
    ...
    'components' => [
        ...
        'request' => [
            'cookieValidationKey' => 'ytsjj65723vsdjd' . hash_hmac('sha256', md5(date('DYM')), sha1(date('myd'))),
            // 'parsers' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                // 'bafric/<controller:[\w-]+>/<action:[\w-]+>' => 'frontend/<controller>/<action>',
                // 'bafric/<controller:[\w-]+>' => 'frontend/<controller>/index',
                // 'bafric' => 'frontend/default/index',
            ],
        ],
    ],
