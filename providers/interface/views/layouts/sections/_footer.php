...
?>
 <footer class="footer-area">
  ...
  object-fit: cover;  /* Ensures image fits within the rounded shape */"  alt="logo" />
              <p>+254758222222</p>
              <span>qaffeepoint1@gmail.com</span>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://github.com/Mandeeq" target="_blank">Iman</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              </p>
            </div>
          </div>
