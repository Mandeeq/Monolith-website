...
/**
 * HomeSectionsSearch represents the model behind the search form of `qaffee\models\HomeSections`.
 */
class HomeSectionsSearch extends HomeSections
{
    /**
     * {@inheritdoc}
     */
